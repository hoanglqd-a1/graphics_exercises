...
public class MyGLRenderer implements GLSurfaceView.Renderer {
    ...
    public MyGLRenderer(float[] source, float[] direction, Context context) {
        // Constructor
...
//        }
        ...
        for (int i=0; i<lines.length; i++){
            ...
            lines[i] = new Line(source, direction, commonProgram, context);
        }
//        int copies = 100;
...
//        }
//        groupedObjects = new GroupedObjects(context, copies, instancedModelMatrices);
